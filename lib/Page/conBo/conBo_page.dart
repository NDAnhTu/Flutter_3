...
class ConBo_page extends StatefulWidget {
  @override
  State<ConBo_page> createState() => _ConBo_pageState();
}

class _ConBo_pageState extends State<ConBo_page> {
    ...
    return Padding(
      ...
      child: Container(
        child: _loading
            ...
            : ListView.builder(
                itemCount: _gsdetail.length,
                itemBuilder: (BuildContext context, int index) {
                  var item_info = _gsdetail[0];
